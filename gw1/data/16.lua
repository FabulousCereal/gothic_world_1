...
un pie esguinzado y la cadera tembleque. Esto de andar atropellada no era muy
...
conocido recíen ayer, pero por alguna razón sospechaba de su capacidad para
saber si algo era grave.]],

	[[Llegué a duras penas hasta la habitación y toqué a la puerta. La
...
Pensé primero que Bake le debió prestar de la suya, pero parecía mas bien que
la había traido en la mochila. En el mueble junto a la alarma estaba su
pistola y un cartucho.]],
...
comiendo galletas abajo. ¿Vienes?"]],
	...
	{"name", "María"},
	[[Esperé a que saliera y fui con en el hasta la escalera.]],
...
y con hecharle una mirada bastó.]],

	{"name", "Falcon"},
	[["Ah, si, es un esguince. Yo tenía el pie igual. Tienes para cuatro
días mas."]],
	...
	{"name", "Falcon"},
	[["Igual si reposas creo que se te va a pasar mas luego. Yo estoy así
porque no he parado de caminar."]],

	{"name", "María"},
	[[Bajamos los dos la escalera a duras penas, y de ahí fuimos al comedor
donde estaban Bake y Croft tomando mate y café.]],
...
le preguntamos sobre como había sobrevivido. Croft se sirvió otro café y
suspiró...]],
}
...
return {
	{"style", "vnMaria"},
	{"name", "María"},
	[[Llegamos cerca de la 1 de la tarde a la casa. El día se estaba
empezando a nublar de nuevo, y Croft comentó que iba a nevar otra vez a la
tarde. Me pregunté si tendrán canal del clima acá, porque parece que todos
saben al ojo lo que va a pasar.]],

	[[En fin. Croft me ayudó a bajar y llegamos hasta la puerta, con Pipi
...
apareció Bake apuntándo a Croft con una pistola.]],
	...
	{"name", "Bake"},
	[["Ah, pensé que era una de esas cosas verdes por los ladridos.
¿Quién es el?"]],
...
dos miramos a Croft, y este miró a Rocco que lo miró de vuelta.]],
	...
	{"name", "Croft"},
	[["¡Perro de--!" Soltó a Rocco y este salió corriendo mientras Croft se
sacudia el brazo. Lo había meado encima. "No podías hacer todo junto." Rocco
terminó de mear en un árbol mientras Croft se quitaba el abrigo. Por suerte
parecía que era impermeable.]],
...
de nuevo volví sin nada.]],
	...
	{"case", "DuermeDonde", {
		Falcon = {
			[[Y ojalá no sea una gripe o algo parecido. Si dormimos
			juntos puede yo tambien termine en las mismas.]],
		}
	}},
...
al pasar frente a la escalera.]],
	...
	{"case", {
		comoEstaFalcon,
		{
			...
			{"name", "Bake"},
			[["¿No querés comida?" me preguntó. "Hay hamburguesa
			con papa frita xD Solo queda una papa xD"]],
			...
			me preguntó susurrando, aunque hasta Bake lo escuchó
			desde la cocina.]],
