...
cualquier criatura venir de lejos.]],
	...
	{"name", "Falcon"},
	[["Si, dejaron armas muy poco potentes. Solo encontré una AK-47. No
tiene balas. ¿Me la llevo igual?"]],
...
como mi G18. Ya encontré tres cagadores."]],
	...
	{"name", "Croft"},
	[["Yo ya tengo esta. Es una Águila Desértica."]],
...
vidrio roto."]],
	...
	{"name", "Croft"},
	[["Ahora que lo dices, eso suena mas fácil."]],

	{"name", "Falcon"},
	[["¿Y para que queremos la gasolinera entonces?"]],

	{"name", "Croft"},
	[["Para no saborear la gasolina."]],
...
"No sé porque dije eso." Antes que pudieramos pensar en la buena racha que
Falcon llevaba hoy, Rocco se puso a dar vueltas en el asiento.]],

	{"name", "María"},
	[["Ay, mierda." Me estiré rápido para abrir la puerta.]],

	{"name", "Falcon"},
	[["¿Que pasa?"]],

	{"name", "María"},
	[["Nada, nada." Rocco salió como bala y se dirigió directo a la rueda.
Había que estar atenta con este perro.]],
...
El vidrio se había trizado pero resistía. Apunté a la criatura.]],

	[[Hice el intento de jalar el gatillo, pero resultó ser mas pesado de
lo que pensé. Tuve que poner ambos dedos para apretarlo. Cerré los ojos
...
en salir.]],
	...
	[[El auto estaba apoyado en el pilar de la gasolinera, que impidió que
...
limpio. Entonces Croft se miró los zapatos.]],
	...
	{"name", "María"},
	[["Tenemos que buscar comida, y yo necesito--"]],
