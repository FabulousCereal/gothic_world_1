return {
	...
	{"name", "María"},
	[[Estacionamos frente a la farmacia de la que habló Bake. Se veía todo
destrozado desde afuera, con cajas de remedios esparcidos por toda la
...
fuerza, botando la nieve.]],
	...
	{"name", "María"},
	[[Al abrir las puertas el viento nos tomó por sorpresa. Corría por la
Avenida con incluso mas fuerza que allá atrás, y también parecía mas helado que
otros días. Las nubes tampoco tenían buena pinta.]],

	[[Le dí la vuelta al auto para ayudarle a Falcon a bajar, y nos metimos
rápido a la farmacia, en parte para refugiarnos del frio.]],

	[[Adentro era casi imposible ver algo, pero todos los estantes de
productos estaban volteados, sin nada en ellos, aunque esos eran los de las
cosas de aseo. Mas adentro, en las repisas tras el mostrador, aún se divisaban
medicamentos.]],

	{"name", "Bake"},
	[["¿No dijo la periodista como se llamaban las pastillas?"]],

	{"name", "María"},
	[["Solo dijo 'antivirales de amplio espectro'."]],

	{"name", "Bake"},
	[["Bueno, ojalá diga eso en la caja. ¿Alguien trajo linterna?"
Ni yo ni Falcon respondimos. "Voy a usar mi celu."]],

	{"name", "Falcon"},
	[["¿Andas con celular?"]],

	{"name", "Bake"},
	[["Si, por si me llamaban mis viejos, lol." Bake abrió un celular tipo
almeja que llevaba. La pantalla se iluminó.]],

	{"name", "Falcon"},
	[["¿Como esperas que te llamen si no hay señal?"]],
...
morir."]],
	...
	{"name", "María"},
	[[Con Falcon fuimos tras Bake mientras este buscaba como destrabar la
puerta. Al final se aburrió y le dió patadas. Así había que abrir todo ahora al
parecer. Pasamos.]],
...
de un hombre.]],
	...
	[[Se encontraba de lado mirando hacia la pared, y traía una mochila.
El cuerpo estaba sobre un charco de sangre; un zombie debió haberlo atacado
acá mismo.]],
...
Bake parecía consternado.]],

	{"name", "Bake"},
	[["O la noticia era vieja, o murió hace muy poco." A Falcon no le
importaba eso. Se quitó un guante y empezó a abrir la caja ahi mismo. "Hey,"
dijo Bake, pero tampoco quisimos detenerlo. Con las manos temblando, Falcon
sacó una pastilla y se la tragó.]],

	{"name", "María"},
	[[Dudabamos de si la necesitaba realmente a estas alturas, pero con la
calma que le trajó, el semblante le mejoró de inmediato, como si se hubiera
salvado por un pelo.]],

	[[Falcon guardó las pastillas, y se puso a sacar todo lo que había en
la mochila.]],

	{"name", "Bake"},
	[["No te lo pensarás tomar todo."]],

	{"name", "Falcon"},
	[["Claro que no, pero necesitamos tener ante cualquier emergencia."]],

	{"name", "María"},
	[[A pesar del tamaño, la mochila estaba de hecho casi vacia. Solo unas
dos cajas mas de viraqur, cuatro de ibuprofeno, y barras de cereal. Eso, y unos
cuadernos. El hombre no había alcanzado a agarrar mucho, o no quedaba cuando
llegó.]],

	{"name", "Falcon"},
	[["Tenemos tres cajas en total, pero una está a medio consumir.
No sé ustedes, pero preferiría seguir buscando."]],

	{"name", "Bake"},
	[["Tenés razón, pero parece que en las repisas ya no quedan..."]],

	{"name", "Falcon"},
	[["Si... Solo queda revisar en la bodega," dijo. Nos miramos en
silencio.]],
...
y Bake iba a dispararle a cualquier cosa que pudiera salir.]],
	...
	[[Nos pusimos en posición, nerviosos. Falcon giró la manilla
silenciosamente, y contó desde tres con los dedos. El corazón me golpeaba el
pecho, y tenía las manos calientes a pesar del frio.]],
...
hacia la otra puerta.]],
	...
	[[Bake entró cauteloso, y yo me apegué a el para iluminar.
Al dar la vuelta encontramos la escena. Apenas cayó algo de luz me alejé.
Alrededor de 6 cuerpos destrozados y apilados en un rincón.]],

	[[Recordando la criatura que salió el pasillo, me giré casi en pánico
...
Quise decirle que no importaba, que podía quedarme aunque fuera a sujetar el
puto celular para alumbrar. "Nena..."]],

	{"name", "María"},
	[[Le devolví el celular a Bake, y salí rápido de la bodega.]],

	{"name", "Falcon"},
	[["¡María, espera!" Falcon se apresuró en seguirme. Llegué hasta
afuera, a la camioneta.]],
}
