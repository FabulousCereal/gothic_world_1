...
venir. Fab se calló de pronto, y Andrea se giró a verme. Ella sonrió.]],
	...
	{"name", "María"},
	[["Bien," respondí simplemente. "¿Que le pasó a Falcon?"]],

	{"name", "Andrea"},
	[["Se empezó a sentir mal luego que te fueras. Intentó tomarse unas
pastillas antivirales, pero Bake se las quitó por que dijo que ya se había
tomado una en la mañana y que no eran caramelos."]],

	{"name", "Fabian"},
	[["Si, lo convencimos de que era una cada 12 horas, y entonces se fue a
acostar."]],
...
para los mareos de Falcon cuando pasara la tormenta," dijo malentendiendo la
pregunta, "aparte de instrumentos para la banda que queremos hacer."]],

	{"name", "María"},
	[["Claro, pero quiero decir... Espera. ¡¿Banda?!" A Andrea se le
iluminó la cara.]],

	{"name", "Andrea"},
	[["Si, queremos traer una batería, algunos pedales, y un teclado para
tocar canciones como una banda."]],

	{"name", "Fabian"},
	[["Y baterías de auto para la luz," agregó Fab.]],

	{"name", "Andrea"},
	[["Si, eso también," asintió. "Vamos a poder tocar a mil y
desestresarnos. ¿No es genial?" Wtf. ¿Ella, desestresarse?]],

	{"name", "Fabian"},
	[["Si, escuchamos los planes de Falcon y Bake, dije 'eso es imposible',
lo pensé, y luego dije 'podría funcionar.'"]],

	{"name", "Andrea"},
	[["Siempre soñé con formar una banda." No tenía caso. Estaban todos
...
como que trata de pasar desapercibido, pero se roba toda la atención al mismo
tiempo. Lamentablemente se me acabó la batería del celular así que no puedo
mostrarte..."]],
	...
	{"name", "Andrea"},
	[["pero es como cuando ves a esos maestros marciales que dominan su
arte por completo, hablando de ser como el agua y hacer el movimiento mínimo.
Es eso mismo pero en batería."]],

	{"name", "Fabian"},
	[["Ahh, entiendo," asintió. "Mientras me digan los acordes, yo toco lo
que sea."]],

	{"name", "Andrea"},
	[["¿No has escuchado artistas así? Que parecen dominar su arte."
Fab se quedó pensando, rascándose la barbilla.]],
...
Así que me enojé y le dije que no estaba mirando nada, le tiré el control por
la cabeza, y me fui."]],
...
derecho a molestarme con Bake por no haber mencionado a su hermana.]],
	...
	[["Me vine sola acá, así que no he sabido de mi familia. Un poco como
tú, creo."]],
...
esperaba, pues..."]],
	...
	{"name", "María"},
	[["El frío," terminé. Los dos rieron. "Es terrible," dije con la
garganta apretada.]],
...
el, con una campera y algo de nieve en los hombros.]],
	...
	{"name", "Bake"},
	[["Volví xD" dijo sonriente. "¿Que hacen?"]],
...
tienen calefacción acá."]],
	...
	{"name", "Andrea"},
	[["Viene caliente desde afuera," dijo Andrea, entendiendo de lo que
...
sistema distinto al de agua fría. Al menos aquí en la ciudad. Donde vivo
